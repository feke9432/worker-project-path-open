    ...
    children: [
      {
        ...
        children: [
          ...
          {
            label: '实时统计报表-游戏推广数据表',
            // fileUrl: 'D:/git_lib/em.602.com/WebRoot/static/vue/report/overview',
            switch: [
              'D:/git_lib/shujujiance_vue/新报表公共样式/newReportStyle/dist',
              'D:/git_lib/em.602.com/WebRoot/static/vue/report/langtimereport'
            ]
          },
          {
            label: '卡回传模板',
          ...
          },
          {
            ...
            switch: [
              'D:/git_lib/shujujiance_vue/新报表公共样式/newReportStyle/dist',
              'D:/git_lib/em.602.com/WebRoot/static/vue/product'
            ]
          },
          {
            label: 'ltv预估',
          ...
          },
          {
            ...
            switch: [
              'D:/git_lib/shujujiance_vue/新报表公共样式/newReportStyle/dist',
              'D:/git_lib/em.602.com/WebRoot/static/vue/report/rechargeRanking'
            ]
          },
          {
            label: '页游推广活动详情',
            switch: [
              'D:/git_lib/shujujiance_vue/新报表公共样式/newReportStyle/dist',
              'D:/git_lib/em-dashiyouxi/WebRoot/static/vue/report/websiteStatistics'
            ]
          },
          {
            label: '配置-聚合页子活动配置',
            switch: [
              'D:/git_lib/shujujiance_vue/新报表公共样式/newReportStyle/dist',
              'D:/git_lib/em.602.com/WebRoot/static/vue/promote/PolyPageConfig'
            ]
          },
          {
            label: '高级-充值用户排行',
          ...
          },
          {
            ...
            switch: [
              'D:/git_lib/shujujiance_vue/新报表公共样式/newReportStyle/dist',
              'D:/git_lib/em.602.com/WebRoot/static/vue/tool/payOrderCallback/'
            ]
          },
          {
            label: '工具-1. 手游用户改归因',
            switch: [
              'D:/git_lib/shujujiance_vue/新报表公共样式/newReportStyle/dist',
              'D:/git_lib/em.602.com/WebRoot/static/vue/tool/ChangeUserPromote/'
            ]
          },
          {
            label: '工具. 手游归因查询',
            switch: [
              'D:/git_lib/shujujiance_vue/新报表公共样式/newReportStyle/dist',
              'D:/git_lib/em.602.com/WebRoot/static/vue/tool/Attribute2/'
            ]
          }
        ]
      },
